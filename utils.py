...
def save_checkpoint(args, model, i_exp, i_task, name):
    ...
    if not os.path.exists(os.path.join(args.checkpoint_dir, args.dataset_name, f"Exp{i_exp}")):
        os.makedirs(os.path.join(args.checkpoint_dir, args.dataset_name, f"Exp{i_exp}"))
